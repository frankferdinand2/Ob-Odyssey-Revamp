...
public class ShellUniverse implements Universe {
   ...
   private String[] levels = {"res/LevelData/tutorial.txt", "res/LevelData/level2.txt", "res/LevelData/level3.txt", "res/LevelData/level4.txt", "res/LevelData/level5.txt", "res/LevelData/level6.txt", "res/LevelData/level7.txt"};
       ...
       for (int i = 0; i < sprites.size(); i++) {
           ...
           if (sprite instanceof ObSprite) {
               ...
               if (ob.getLevelComplete() && !infiniteMode) {
            	   if (levelHighScores[currentLevelIndex] == 0 || (levelTimer / 1000.0) < levelHighScores[currentLevelIndex]) {
