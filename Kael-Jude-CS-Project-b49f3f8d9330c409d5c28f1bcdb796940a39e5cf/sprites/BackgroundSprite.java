...
public class BackgroundSprite implements DisplayableSprite {
	...
	public BackgroundSprite(double centerX, double centerY, double width, double height) {
		this(centerX, centerY, width, height, DEFAULT_IMAGE_PATH);
	}

	public BackgroundSprite(double centerX, double centerY, double width, double height, String imagePath) {
